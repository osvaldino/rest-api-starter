...
'sanctum.csrf-cookie',
'projects.index','projects.store','projects.show','projects.update','projects.destroy',
'tasks.index','tasks.store','tasks.show','tasks.update','tasks.destroy',
'categories.index','categories.store','categories.show','categories.update','categories.destroy','storage.local','storage.local.upload',);
...
'DB_PASSWORD','FORWARD_DB_PORT','API_RATE_LIMIT','SANCTUM_STATEFUL_DOMAINS','SESSION_DRIVER',
'SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION',
'FILESYSTEM_DISK','QUEUE_CONNECTION','CACHE_STORE','REDIS_CLIENT','REDIS_HOST',
